...
import com.example.validators.RepositoryException;
...
public class ControllerLogin {
    ...
    protected void onClickLogIn(ActionEvent actionEvent) throws IOException, NoSuchAlgorithmException {
        ...
        try {
            ...
            if (encoded.equals(utilizator.getPassword())) {
                ...
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/friendlist-view.fxml"));
    ...
    public void onClickGoToSignUp(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/signup-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
