...
public class ControllerFriendList {
    ...
    public void onClickForFriendRequests(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/friendrequest-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickViewSentFriendRequests(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/sentfriendrequests-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickStartChat(ActionEvent actionEvent) throws IOException {
        if (tableViewFriendList.getSelectionModel().getSelectedItem() == null) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/chat-view.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickRapoarte(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/rapoarte-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickCreeazaEveniment(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/createevent-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickVeziEvenimente(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/events-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
    ...
    public void onClickEvenimenteLaCareParticip(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("com/example/participatingevents-view.fxml"));
        Parent root = (Parent) fxmlLoader.load();
